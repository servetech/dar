   ...
   <link rel="stylesheet" href="/zeprs/css/styles-moz.css" charset="ISO-8859-1" type="text/css"/>   </head>  <body>
    <table class="enhancedtable">
      ...
      <tr>
         ...
         <td><xsl:value-of select="infant_sleeping_pattern"/></td>
         <td><xsl:value-of select="passing_urine"/></td>
         <td><xsl:value-of select="passing_stool"/></td>
         ...
         <td><xsl:value-of select="jaundice"/></td>
         <td><xsl:value-of select="fever"/></td>
         <td><xsl:value-of select="skin_rashes"/></td>
         <td><xsl:value-of select="eye_discharge"/></td>
         <td><xsl:value-of select="abdominal_distension"/></td>
         <td><xsl:value-of select="excessive_crying"/></td>
         <td><xsl:value-of select="cord_problem"/></td>
